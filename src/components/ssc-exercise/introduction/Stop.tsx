...
const Stop: React.FC = () => {
  return (
    <section>
      ...
      <p>
        In this chapter, you will brainstorm and discuss what are the things you should <span className='font-bold'>stop</span> doing
        as a community to better support the productivity, communication, etc. Give an example of
        how this point might help you and the community to thrive.
      </p>
    </section>
  );
};
