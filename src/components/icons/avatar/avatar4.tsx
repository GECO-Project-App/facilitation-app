...
export const Avatar4: FC<React.SVGProps<SVGSVGElement>> = ({
  height = 90,
  width = 86,
  fill = Colors.Green,
  children,
  ...
  return (
    <svg
      ...
      <path
        ...
        stroke="black"
      />
      <rect x="23.5" y="15.5" width="19" height="8" rx="4" fill="white" stroke="black" />
      <rect x="28.5" y="16.5" width="9" height="6" rx="3" fill="black" stroke="black" />
      <rect x="43.5" y="15.5" width="19" height="8" rx="4" fill="white" stroke="black" />
      <path
        d="M46.6175 29C46.6175 36.0102 38.7563 36.0102 38.7563 29"
        stroke="black"
        strokeLinecap="round"
      />
      <rect x="48.5" y="16.5" width="8" height="6" rx="3" fill="black" stroke="black" />
    </svg>
  );
};
