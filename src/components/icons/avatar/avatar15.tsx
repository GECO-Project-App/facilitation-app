...
export const Avatar15: FC<React.SVGProps<SVGSVGElement>> = ({
  height = 76,
  width = 86,
  fill = Colors.Green,
  children,
  ...
  return (
    <svg
      ...
      <path
        ...
        stroke="black"
      />
      <rect x="13.5" y="1.11084" width="29" height="34" rx="14.5" fill="black" stroke="black" />
      <rect x="19" y="5.61084" width="18" height="25" rx="9" fill="white" />
      <rect x="18.5" y="12.1108" width="9" height="12" rx="4.5" fill="black" stroke="black" />
      <rect x="43.5" y="1.11084" width="28" height="34" rx="14" fill="black" stroke="black" />
      <path
        d="M46.6175 37.2751C46.6175 44.2853 38.7563 44.2853 38.7563 37.2751"
        stroke="black"
        strokeLinecap="round"
      />
      <rect x="48" y="5.61084" width="19" height="25" rx="9.5" fill="white" />
      <rect x="47.5" y="12.1108" width="9" height="12" rx="4.5" fill="black" stroke="black" />
    </svg>
  );
};
